...
! 
!     integer,allocatable,intent(in) :: unicode(:)
!     !
...
! OPTIONS
! 
!    + UNICODE :  An INTEGER array of Unicode codepoint values representing
...
!     CHARACTER values
!   + the returned values in UNICODE are of default INTEGER kind
...
! LICENSE
!     MIT
impure elemental function get_arg_ia(pos,default) result(value)
...
impure elemental function get_arg_iu(pos,default) result(value)
integer,intent(in)            :: pos
type(unicode_type),intent(in) :: default
character(len=:),allocatable  :: temp
type(unicode_type)            :: value
...
!===================================================================================================================================
function oop_get_arg_iu(self,pos) result (value)
class(unicode_type),intent(in)       :: self
integer,intent(in)                   :: pos
type(unicode_type)                   :: value
   value=get_arg_iu(pos,self)
